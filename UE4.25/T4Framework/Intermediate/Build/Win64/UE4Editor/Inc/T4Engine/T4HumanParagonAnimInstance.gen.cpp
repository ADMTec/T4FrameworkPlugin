...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UT4HumanParagonAnimInstance_Statics::NewProp_PostureVariables_MetaData[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "Variable" },
		{ "ModuleRelativePath", "Private/World/Actor/Animation/Human/Paragon/T4HumanParagonAnimInstance.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UT4HumanParagonAnimInstance_Statics::NewProp_PostureVariables = { "PostureVariables", nullptr, (EPropertyFlags)0x0020080000000815, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UT4HumanParagonAnimInstance, PostureVariables), Z_Construct_UScriptStruct_FT4HumanPostureAnimVariables, METADATA_PARAMS(Z_Construct_UClass_UT4HumanParagonAnimInstance_Statics::NewProp_PostureVariables_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UT4HumanParagonAnimInstance_Statics::NewProp_PostureVariables_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UT4HumanParagonAnimInstance_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UT4HumanParagonAnimInstance_Statics::NewProp_PostureVariables,
	...
	IMPLEMENT_CLASS(UT4HumanParagonAnimInstance, 2497812967);
