...
void EmptyLinkFunctionForGeneratedCodeT4ContentSpawnPrefabStructs() {}
...
class UScriptStruct* FT4ContentSpawnPrefabData::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern T4GAMEDATA_API uint32 Get_Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData, Z_Construct_UPackage__Script_T4GameData(), TEXT("T4ContentSpawnPrefabData"), sizeof(FT4ContentSpawnPrefabData), Get_Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Hash());
	}
	return Singleton;
}
template<> T4GAMEDATA_API UScriptStruct* StaticStruct<FT4ContentSpawnPrefabData>()
{
	return FT4ContentSpawnPrefabData::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4ContentSpawnPrefabData(FT4ContentSpawnPrefabData::StaticStruct, TEXT("/Script/T4GameData"), TEXT("T4ContentSpawnPrefabData"), false, nullptr, nullptr);
static struct FScriptStruct_T4GameData_StaticRegisterNativesFT4ContentSpawnPrefabData
{
	FScriptStruct_T4GameData_StaticRegisterNativesFT4ContentSpawnPrefabData()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("T4ContentSpawnPrefabData")),new UScriptStruct::TCppStructOps<FT4ContentSpawnPrefabData>);
	}
} ScriptStruct_T4GameData_StaticRegisterNativesFT4ContentSpawnPrefabData;
	struct Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Classes/Content/T4ContentSpawnPrefabStructs.h" },
	};
#endif
	void* Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewStructOps()
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FT4ContentSpawnPrefabData>();
	}
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_FolderName_MetaData[] = {
		{ "Category", "Hide" },
		{ "Comment", "// #122\n" },
		{ "ModuleRelativePath", "Classes/Content/T4ContentSpawnPrefabStructs.h" },
		{ "ToolTip", "#122" },
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_FolderName = { "FolderName", nullptr, (EPropertyFlags)0x0010000800020001, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FT4ContentSpawnPrefabData, FolderName), METADATA_PARAMS(Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_FolderName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_FolderName_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_ParentID_MetaData[] = {
		{ "Category", "Hide" },
		{ "ModuleRelativePath", "Classes/Content/T4ContentSpawnPrefabStructs.h" },
	};
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_ParentID = { "ParentID", nullptr, (EPropertyFlags)0x0010000800020001, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FT4ContentSpawnPrefabData, ParentID), METADATA_PARAMS(Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_ParentID_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_ParentID_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_Description_MetaData[] = {
		{ "Category", "Editor" },
		{ "ModuleRelativePath", "Classes/Content/T4ContentSpawnPrefabStructs.h" },
	};
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_Description = { "Description", nullptr, (EPropertyFlags)0x0010000800000001, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FT4ContentSpawnPrefabData, Description), METADATA_PARAMS(Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_Description_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_Description_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_OverrideBehaviorData_MetaData[] = {
		{ "Category", "ServerOnly" },
		{ "ModuleRelativePath", "Classes/Content/T4ContentSpawnPrefabStructs.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_OverrideBehaviorData = { "OverrideBehaviorData", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FT4ContentSpawnPrefabData, OverrideBehaviorData), Z_Construct_UScriptStruct_FT4SpawnOverrideBehaviorData, METADATA_PARAMS(Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_OverrideBehaviorData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_OverrideBehaviorData_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_NPCDBKey_MetaData[] = {
		{ "Category", "ServerOnly" },
		{ "ModuleRelativePath", "Classes/Content/T4ContentSpawnPrefabStructs.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_NPCDBKey = { "NPCDBKey", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FT4ContentSpawnPrefabData, NPCDBKey), Z_Construct_UScriptStruct_FT4NPCDBKey, METADATA_PARAMS(Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_NPCDBKey_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_NPCDBKey_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_ID_MetaData[] = {
		{ "Category", "Common" },
		{ "Comment", "// FT4ContentSpawnPrefabDetails::CustomizeDetails\n" },
		{ "ModuleRelativePath", "Classes/Content/T4ContentSpawnPrefabStructs.h" },
		{ "ToolTip", "FT4ContentSpawnPrefabDetails::CustomizeDetails" },
	};
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_ID = { "ID", nullptr, (EPropertyFlags)0x0010000000020001, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FT4ContentSpawnPrefabData, ID), METADATA_PARAMS(Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_ID_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_ID_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::PropPointers[] = {
#if WITH_EDITORONLY_DATA
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_FolderName,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_ParentID,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_Description,
#endif // WITH_EDITORONLY_DATA
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_OverrideBehaviorData,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_NPCDBKey,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::NewProp_ID,
	};
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_T4GameData,
		nullptr,
		&NewStructOps,
		"T4ContentSpawnPrefabData",
		sizeof(FT4ContentSpawnPrefabData),
		alignof(FT4ContentSpawnPrefabData),
		Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::PropPointers,
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::Struct_MetaDataParams))
	};
	UScriptStruct* Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData()
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Hash();
		UPackage* Outer = Z_Construct_UPackage__Script_T4GameData();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("T4ContentSpawnPrefabData"), sizeof(FT4ContentSpawnPrefabData), Get_Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Hash(), false);
#else
		static UScriptStruct* ReturnStruct = nullptr;
#endif
		if (!ReturnStruct)
		{
			UE4CodeGen_Private::ConstructUScriptStruct(ReturnStruct, Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Statics::ReturnStructParams);
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FT4ContentSpawnPrefabData_Hash() { return 289171117U; }
...
static struct FScriptStruct_T4GameData_StaticRegisterNativesFT4SpawnOverrideBehaviorData
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4SpawnOverrideBehaviorData_Hash() { return 2565788797U; }
