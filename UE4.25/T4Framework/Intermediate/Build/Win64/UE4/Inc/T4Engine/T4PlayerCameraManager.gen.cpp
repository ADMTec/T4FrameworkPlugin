...
// Cross Module References
	T4ENGINE_API UClass* Z_Construct_UClass_AT4PlayerCameraManager_NoRegister();
	T4ENGINE_API UClass* Z_Construct_UClass_AT4PlayerCameraManager();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AT4PlayerCameraManager_Statics::Class_MetaDataParams[] = {
		...
		{ "IncludePath", "Camera/T4PlayerCameraManager.h" },
		{ "ModuleRelativePath", "Classes/Camera/T4PlayerCameraManager.h" },
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AT4PlayerCameraManager_Statics::ClassParams = {
		...
		0,
		0x009002ACu,
		METADATA_PARAMS(Z_Construct_UClass_AT4PlayerCameraManager_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_AT4PlayerCameraManager_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AT4PlayerCameraManager, 3833583953);
	template<> T4ENGINE_API UClass* StaticClass<AT4PlayerCameraManager>()
	{
		return AT4PlayerCameraManager::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AT4PlayerCameraManager(Z_Construct_UClass_AT4PlayerCameraManager, &AT4PlayerCameraManager::StaticClass, TEXT("/Script/T4Engine"), TEXT("AT4PlayerCameraManager"), false, nullptr, nullptr, nullptr);
