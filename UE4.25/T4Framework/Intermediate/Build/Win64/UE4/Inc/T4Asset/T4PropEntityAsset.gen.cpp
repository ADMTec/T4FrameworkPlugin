...
static struct FScriptStruct_T4Asset_StaticRegisterNativesFT4EntityPropPhysicalData
{
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UT4PropEntityAsset_Statics::NewProp_Rendering = { "Rendering", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UT4PropEntityAsset, Rendering), Z_Construct_UScriptStruct_FT4EntityPropRenderingData, METADATA_PARAMS(Z_Construct_UClass_UT4PropEntityAsset_Statics::NewProp_Rendering_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UT4PropEntityAsset_Statics::NewProp_Rendering_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UT4PropEntityAsset_Statics::NewProp_AnimationData_MetaData[] = {
		{ "Category", "Common" },
		{ "ModuleRelativePath", "Classes/Entity/T4PropEntityAsset.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UT4PropEntityAsset_Statics::NewProp_AnimationData = { "AnimationData", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UT4PropEntityAsset, AnimationData), Z_Construct_UScriptStruct_FT4EntityPropAnimationData, METADATA_PARAMS(Z_Construct_UClass_UT4PropEntityAsset_Statics::NewProp_AnimationData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UT4PropEntityAsset_Statics::NewProp_AnimationData_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UT4PropEntityAsset_Statics::NewProp_MeshData_MetaData[] = {
		{ "Category", "Common" },
		{ "ModuleRelativePath", "Classes/Entity/T4PropEntityAsset.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UT4PropEntityAsset_Statics::NewProp_MeshData = { "MeshData", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UT4PropEntityAsset, MeshData), Z_Construct_UScriptStruct_FT4EntityPropMeshData, METADATA_PARAMS(Z_Construct_UClass_UT4PropEntityAsset_Statics::NewProp_MeshData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UT4PropEntityAsset_Statics::NewProp_MeshData_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UT4PropEntityAsset_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UT4PropEntityAsset_Statics::NewProp_AnimationData,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UT4PropEntityAsset_Statics::NewProp_MeshData,
	};
	...
	IMPLEMENT_CLASS(UT4PropEntityAsset, 3601092882);
