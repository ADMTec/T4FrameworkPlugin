...
void EmptyLinkFunctionForGeneratedCodeT4GameplaySettings() {}
// Cross Module References
	T4GAMEPLAY_API UClass* Z_Construct_UClass_UT4GameplaySettings_NoRegister();
	T4GAMEPLAY_API UClass* Z_Construct_UClass_UT4GameplaySettings();
...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UT4GameplaySettings_NoRegister()
	{
		return UT4GameplaySettings::StaticClass();
	}
	struct Z_Construct_UClass_UT4GameplaySettings_Statics
	{
...
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_IndicatorAttackTargetOutlineColor;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_QuestInfoUserWidgetClass_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_QuestInfoUserWidgetClass;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DefaultCrosshairTextureScale_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_DefaultCrosshairTextureScale;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_GameModeLayoutUserWidgetClass_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_GameModeLayoutUserWidgetClass;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DefaultGameContentName_MetaData[];
#endif
		static const UE4CodeGen_Private::FNamePropertyParams NewProp_DefaultGameContentName;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DefaultGameMasterTablePath_MetaData[];
#endif
		static const UE4CodeGen_Private::FSoftObjectPropertyParams NewProp_DefaultGameMasterTablePath;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
		static const FCppClassTypeInfoStatic StaticCppClassTypeInfo;
		static const UE4CodeGen_Private::FClassParams ClassParams;
	};
	UObject* (*const Z_Construct_UClass_UT4GameplaySettings_Statics::DependentSingletons[])() = {
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_IndicatorAttackTargetOutlineColor = { "IndicatorAttackTargetOutlineColor", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UT4GameplaySettings, IndicatorAttackTargetOutlineColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_IndicatorAttackTargetOutlineColor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_IndicatorAttackTargetOutlineColor_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_QuestInfoUserWidgetClass_MetaData[] = {
		{ "Category", "Game System UI" },
		{ "ModuleRelativePath", "Public/Settings/T4GameplaySettings.h" },
	};
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_QuestInfoUserWidgetClass = { "QuestInfoUserWidgetClass", nullptr, (EPropertyFlags)0x0014000000004001, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UT4GameplaySettings, QuestInfoUserWidgetClass), Z_Construct_UClass_UT4BuiltinUserWidget_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_QuestInfoUserWidgetClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_QuestInfoUserWidgetClass_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_DefaultCrosshairTextureScale = { "DefaultCrosshairTextureScale", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UT4GameplaySettings, DefaultCrosshairTextureScale), METADATA_PARAMS(Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_DefaultCrosshairTextureScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_DefaultCrosshairTextureScale_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_GameModeLayoutUserWidgetClass_MetaData[] = {
		{ "Category", "Game Mode" },
...
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_GameModeLayoutUserWidgetClass = { "GameModeLayoutUserWidgetClass", nullptr, (EPropertyFlags)0x0014000000004001, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UT4GameplaySettings, GameModeLayoutUserWidgetClass), Z_Construct_UClass_UT4BuiltinUserWidget_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_GameModeLayoutUserWidgetClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_GameModeLayoutUserWidgetClass_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_DefaultGameContentName_MetaData[] = {
		{ "Category", "Game DB" },
		{ "Comment", "// #48, #135\n" },
		{ "ModuleRelativePath", "Public/Settings/T4GameplaySettings.h" },
		{ "ToolTip", "#48, #135" },
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_DefaultGameContentName = { "DefaultGameContentName", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UT4GameplaySettings, DefaultGameContentName), METADATA_PARAMS(Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_DefaultGameContentName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_DefaultGameContentName_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_DefaultGameMasterTablePath_MetaData[] = {
		{ "Category", "Game DB" },
...
#endif
	const UE4CodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_DefaultGameMasterTablePath = { "DefaultGameMasterTablePath", nullptr, (EPropertyFlags)0x0014000000004001, UE4CodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UT4GameplaySettings, DefaultGameMasterTablePath), Z_Construct_UClass_UDataTable_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_DefaultGameMasterTablePath_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_DefaultGameMasterTablePath_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UT4GameplaySettings_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_QuestInfoUserWidgetClass,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_GameModeLayoutUserWidgetClass,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_DefaultGameContentName,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UT4GameplaySettings_Statics::NewProp_DefaultGameMasterTablePath,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UT4GameplaySettings_Statics::ClassParams = {
		&UT4GameplaySettings::StaticClass,
		"T4Framework",
		&StaticCppClassTypeInfo,
		DependentSingletons,
		nullptr,
		Z_Construct_UClass_UT4GameplaySettings_Statics::PropPointers,
		nullptr,
	...
	UClass* Z_Construct_UClass_UT4GameplaySettings()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UT4GameplaySettings_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UT4GameplaySettings, 1520816470);
	template<> T4GAMEPLAY_API UClass* StaticClass<UT4GameplaySettings>()
	{
		return UT4GameplaySettings::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UT4GameplaySettings(Z_Construct_UClass_UT4GameplaySettings, &UT4GameplaySettings::StaticClass, TEXT("/Script/T4Gameplay"), TEXT("UT4GameplaySettings"), false, nullptr, nullptr, nullptr);
	DEFINE_VTABLE_PTR_HELPER_CTOR(UT4GameplaySettings);
