...
USTRUCT()
struct T4GAMEDATA_API FT4ContentSpawnPrefabData
{
	GENERATED_USTRUCT_BODY()

public:
	FT4ContentSpawnPrefabData()
	...
	FORCEINLINE bool operator==(const FT4ContentSpawnPrefabData& InRhs) const
	{
		return (ID == InRhs.ID) ? true : false;
	}

	// FT4ContentSpawnPrefabDetails::CustomizeDetails
