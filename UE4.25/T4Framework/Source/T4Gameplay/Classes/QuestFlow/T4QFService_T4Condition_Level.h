...
#include "T4QFService_T4Condition_Level.generated.h"
...
UCLASS()
class T4GAMEPLAY_API UT4QFService_T4Condition_Level : public UT4QFService_T4ConditionBase
{
	GENERATED_BODY()

public:
	UT4QFService_T4Condition_Level();

	ET4QFBranchConditionType GetConditionType() const override { return ET4QFBranchConditionType::Level; }
