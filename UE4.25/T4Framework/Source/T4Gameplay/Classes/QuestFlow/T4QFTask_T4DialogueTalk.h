...
#include "T4QFTask_T4DialogueTalk.generated.h"

/**
  * #163
 */
UCLASS(hidecategories = (Task))
class T4GAMEPLAY_API UT4QFTask_T4DialogueTalk : public UBTTask_Wait
{
...
public:
	...
	ET4GameDialogueSpeakerType SpeakerType; // #163

	UPROPERTY(EditAnywhere, Category = ServerOnly)
	FName SpeakerDBKeyName; // #163

	UPROPERTY(EditAnywhere, Category = ServerOnly)
	FT4DialogueTextDBKey DialogueTextDBKey; // #164
};
