...
#include "ActionPack/T4ActionPackDatas.h"
#include "T4ActionPackAsset.generated.h"

/**
  * #24
 */
struct FT4ActionPackCustomVersion
{
	enum Type
	{
		InitializeVer = 0,
...
class T4ASSET_API UT4ActionPackAsset : public UObject
{
