...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UT4EditorPathSegmentController_Statics::NewProp_RangeSpread_MetaData[] = {
		{ "Category", "ServerOnly" },
		{ "Comment", "// #161\n" },
		{ "ModuleRelativePath", "Public/Helper/T4EditorPathSegmentController.h" },
		{ "ToolTip", "#161" },
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UT4EditorPathSegmentController_Statics::NewProp_RangeSpread = { "RangeSpread", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UT4EditorPathSegmentController, RangeSpread), METADATA_PARAMS(Z_Construct_UClass_UT4EditorPathSegmentController_Statics::NewProp_RangeSpread_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UT4EditorPathSegmentController_Statics::NewProp_RangeSpread_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UT4EditorPathSegmentController_Statics::NewProp_SpeedScale_MetaData[] = {
		{ "Category", "ServerOnly" },
		{ "Comment", "// #156\n" },
		{ "ModuleRelativePath", "Public/Helper/T4EditorPathSegmentController.h" },
		{ "ToolTip", "#156" },
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UT4EditorPathSegmentController_Statics::NewProp_SpeedScale = { "SpeedScale", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UT4EditorPathSegmentController, SpeedScale), METADATA_PARAMS(Z_Construct_UClass_UT4EditorPathSegmentController_Statics::NewProp_SpeedScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UT4EditorPathSegmentController_Statics::NewProp_SpeedScale_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UT4EditorPathSegmentController_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UT4EditorPathSegmentController_Statics::NewProp_RangeSpread,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UT4EditorPathSegmentController_Statics::NewProp_SpeedScale,
	...
	IMPLEMENT_CLASS(UT4EditorPathSegmentController, 1127357684);
