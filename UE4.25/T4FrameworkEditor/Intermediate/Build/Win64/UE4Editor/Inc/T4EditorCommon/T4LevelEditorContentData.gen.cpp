...
#include "T4EditorCommon/Private/LevelEditor/T4LevelEditorContentData.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	T4EDITORCOMMON_API UScriptStruct* Z_Construct_UScriptStruct_FT4LevelEditorContentData();
...
class UScriptStruct* FT4LevelEditorContentData::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern T4EDITORCOMMON_API uint32 Get_Z_Construct_UScriptStruct_FT4LevelEditorContentData_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FT4LevelEditorContentData, Z_Construct_UPackage__Script_T4EditorCommon(), TEXT("T4LevelEditorContentData"), sizeof(FT4LevelEditorContentData), Get_Z_Construct_UScriptStruct_FT4LevelEditorContentData_Hash());
	}
	return Singleton;
}
template<> T4EDITORCOMMON_API UScriptStruct* StaticStruct<FT4LevelEditorContentData>()
{
	return FT4LevelEditorContentData::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FT4LevelEditorContentData(FT4LevelEditorContentData::StaticStruct, TEXT("/Script/T4EditorCommon"), TEXT("T4LevelEditorContentData"), false, nullptr, nullptr);
static struct FScriptStruct_T4EditorCommon_StaticRegisterNativesFT4LevelEditorContentData
{
	FScriptStruct_T4EditorCommon_StaticRegisterNativesFT4LevelEditorContentData()
	{
...
} ScriptStruct_T4EditorCommon_StaticRegisterNativesFT4LevelEditorContentData;
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FT4LevelEditorContentData_Statics::Struct_MetaDataParams[] = {
		{ "Comment", "/**\n  * #149\n */" },
		{ "ModuleRelativePath", "Private/LevelEditor/T4LevelEditorContentData.h" },
		{ "ToolTip", "#149" },
	};
#endif
	...
	uint32 Get_Z_Construct_UScriptStruct_FT4LevelEditorContentData_Hash() { return 1189969565U; }
